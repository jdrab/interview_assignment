<?php
$this->layout('template', ['title' => 'Reakcia na komentár']);
?>
...
<form enctype="multipart/form-data" action="/create-comment" method="post">
    ...
    <div class="border btn-light p-3 mt-5 mb-5">
        ...
        <div class="form-floating mb-3">
            <input type="text" tabindex="1" name="author" class="form-control" id="commentAuthor" placeholder="Vase meno">
            <label for="commentAuthor">Vaše meno</label>
        </div>

        <div class="form-floating mb-3">
            <textarea tabindex="2" maxlength="1024" name="body" id="commentBody" class="form-control" placeholder="Vas komentar" style="height: 100px"></textarea>
        ...
        <div class="d-flex justify-content-between">
            ...
            <button tabindex="3" type="submit" class="btn btn-primary"><i class="bi bi-check-lg"></i> Odoslať</button>
        </div>
